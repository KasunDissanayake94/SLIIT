...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2017 at 10:45 PM
...
INSERT INTO `doctor` (`doc_NIC`, `doc_Name`, `doc_Spec`, `password`, `imageLink`) VALUES
('637411111V', 'QR Adikari', 'General Physician', 'abc', '..\\images\\doctors\\t1.jpg'),
('642356789V', 'ST Peter', 'Dental Surgeon', '', '..\\images\\doctors\\t2.jpg'),
('652121212V', 'UV Dias', 'Chest Specialist', '', '..\\images\\doctors\\t3.jpg'),
('700501112V', 'WD Perera', 'Surgeon', 'qwerty', '..\\images\\doctors\\t4.jpg'),
('712540000V', 'DMKP Dissanayake', 'Heart Specialist', 'dmkp', '..\\images\\doctors\\t5.jpg');
...
CREATE TABLE IF NOT EXISTS `session` (
  ...
  `current_Times` varchar(15) NOT NULL DEFAULT '00:00:00',
...
INSERT INTO `session` (`session_ID`, `session_Date`, `session_Time`, `doc_NIC`, `counter`, `avg_Time`, `current_Times`) VALUES
('S0001', '2017-01-20', 1600, '637411111V', 7, 0.00000672398, '1506033824'),
('S0002', '2017-01-21', 1700, '637411111V', 0, 0, '00:00:00'),
('S0003', '2017-01-25', 1700, '652121212V', 0, 0, '00:00:00'),
('S0004', '2017-02-01', 1300, '652121212V', 0, 0, '00:00:00'),
('S0005', '2017-01-23', 1400, '642356789V', 1, 0, '00:00:00');
